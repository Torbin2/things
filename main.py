...
#changable
circles = [(400, 300), (415, 300), (430, 300), (445, 300), (445, 300), (445, 300), (445, 300), (445, 300)]
sizes = [40, 30, 25, 20, 18, 15, 13, 10]
...
def calc_eyeballs(head_cent, mouse_pos):
    ...
    turns_angle = (angle - 0.5 * math.pi, angle + 0.5 * math.pi) #sos cas toa, s = 5
...
def draw_eyes(eyes):
    for i in range(2):
        pg.draw.circle(screen, ("red"), eyes[i], EYE_SIZE * SCALE)
...
while True:
    ...
    for num in range(len(circles)):
        pg.draw.circle(screen, ("white"), (int(circles[num][0]) * SCALE, int(circles[num][1]) * SCALE), sizes[num] * SCALE)
